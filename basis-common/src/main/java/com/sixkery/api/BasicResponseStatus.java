...
/**
 * Inherited from {@code org.springframework.http.HttpStatus}
 *
 * Create by Maoning in 2019/9/26
 */
public enum BasicResponseStatus implements ResponseStatus {
     ...
     * 参数校验失败，自定义扩展状态
     */
    REQUEST_ARGUMENTS_ERROR(418, "Arguments Validation Error"),
    ...
    BasicResponseStatus(int value, String reasonPhrase) {
        this.value = value;
